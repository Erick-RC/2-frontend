...
const NewTestBtn = ({setView}) => {
  return (

      <li>
        <a href="#" onClick={() => setView('createExam')} className="focus:outline-none focus:ring-2 focus:ring-gray-200 flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-600 group">
